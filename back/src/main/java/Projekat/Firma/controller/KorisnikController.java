...
import Projekat.Firma.dto.AuthKorisnikDto;
import Projekat.Firma.dto.KorisnikDTO;
import Projekat.Firma.enumeration.KorisnickaUloga;
import Projekat.Firma.model.Korisnik;
import Projekat.Firma.security.TokenUtils;
import Projekat.Firma.service.KorisnikService;
import Projekat.Firma.support.KorisnikDtoToKorisnik;
import Projekat.Firma.support.KorisnikToKorisnikDto;
...
//    @PreAuthorize("hasRole('ROLE_ADMIN')")
    ...
    @GetMapping(value = "/komercijala")
    public ResponseEntity<List<KorisnikDTO>> getByUlogaKomercijala (){
    	KorisnickaUloga uloga = KorisnickaUloga.KOMERCIJALA;
        List<Korisnik> komercijalisti = korisnikService.findByUloga(uloga);
        return new ResponseEntity<>(toKorisnikDto.convert(komercijalisti), HttpStatus.OK);
    }
    
    @GetMapping(value = "/vozaci")
    public ResponseEntity<List<KorisnikDTO>> getByUlogaVozac (){
    	KorisnickaUloga uloga = KorisnickaUloga.VOZAC;
        List<Korisnik> komercijalisti = korisnikService.findByUloga(uloga);
        return new ResponseEntity<>(toKorisnikDto.convert(komercijalisti), HttpStatus.OK);
    }
